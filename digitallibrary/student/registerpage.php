...
if(isset($_POST['signup']))
{
 ...
 if($count==0)
  {
   mysqli_query($db,"INSERT INTO `STUDENT` VALUES('$_POST[firstname]','$_POST[middlename]','$_POST[lastname]','$_POST[PRN]','$_POST[mobilenumber]','$_POST[email]','$username','$password','user.jpeg');");
